---
title: "Differentiable Sampling from Discrete Distributions"
date: "2024-12-23"
author: "Abhyuday"
categories: [code]
---
...
But, what if sampling is required during training phase e.g sampling vectors from a codebook while training a VQVAE or in tasks like reinforcement learning or generative modeling, sampling is necessary to explore different actions or outputs.
